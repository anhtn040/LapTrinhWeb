					...
					<form class="login100-form validate-form">
						...
						<div class="container-login100-form-btn">
							<button class="login100-form-btn">
								<input type="submit" value="" class="signup-button" /> Đăng nhập
							</button>
						</div>
						...
						<div class="text-center p-t-12">
							<a class="txt2" href="account/register.htm"> Chưa có tài khoản thì tạo ngay nào <i class="fa fa-long-arrow-right m-l-5"
								aria-hidden="true"></i>
							</a>
						</div>
					</form>
